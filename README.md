...
### Quick start (CDN)
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/SpotTune/pdf-flipbook@v1.1.2/dist/flipbook.css">
<div id="flip" style="height:100dvh"></div>
<script src="https://cdn.jsdelivr.net/gh/SpotTune/pdf-flipbook@v1.1.2/dist/flipbook.js"></script>
<script>
